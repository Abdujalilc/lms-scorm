...
namespace adlcp_rootv1p2.imscp
{
    public class manifestType : Altova.Node
    {
        ...
        public override void AdjustPrefix()
        {
            ...
            nCount = DomChildCount(NodeType.Element, "http://www.imsproject.org/xsd/imscp_rootv1p1p2", "organizations");
            for (int i = 0; i < nCount; i++)
            {
                XmlNode DOMNode = GetDomChildAt(NodeType.Element, "http://www.imsproject.org/xsd/imscp_rootv1p1p2", "organizations", i);
                InternalAdjustPrefix(DOMNode, false);
                new organizationsType(DOMNode).AdjustPrefix();
            }

            nCount = DomChildCount(NodeType.Element, "http://www.imsproject.org/xsd/imscp_rootv1p1p2", "resources");
            for (int i = 0; i < nCount; i++)
            {
                XmlNode DOMNode = GetDomChildAt(NodeType.Element, "http://www.imsproject.org/xsd/imscp_rootv1p1p2", "resources", i);
                InternalAdjustPrefix(DOMNode, false);
                new resourcesType(DOMNode).AdjustPrefix();
            }

            nCount = DomChildCount(NodeType.Element, "http://www.imsproject.org/xsd/imscp_rootv1p1p2", "manifest");
            for (int i = 0; i < nCount; i++)
            {
                XmlNode DOMNode = GetDomChildAt(NodeType.Element, "http://www.imsproject.org/xsd/imscp_rootv1p1p2", "manifest", i);
                InternalAdjustPrefix(DOMNode, false);
        ...
        {
            return new versionType(GetDomNodeValue(GetDomChildAt(NodeType.Attribute, "", "version", index)));
        }
        ...
        {
            return DomChildCount(NodeType.Element, "http://www.imsproject.org/xsd/imscp_rootv1p1p2", "organizations");
        }
        ...
        {
            return HasDomChild(NodeType.Element, "http://www.imsproject.org/xsd/imscp_rootv1p1p2", "organizations");
        }

        public organizationsType GetorganizationsAt(int index)
        {
            return new organizationsType(GetDomChildAt(NodeType.Element, "http://www.imsproject.org/xsd/imscp_rootv1p1p2", "organizations", index));
        }
        ...
        {
            RemoveDomChildAt(NodeType.Element, "http://www.imsproject.org/xsd/imscp_rootv1p1p2", "organizations", index);
        }
        ...
        {
            AppendDomElement("http://www.imsproject.org/xsd/imscp_rootv1p1p2", "organizations", newValue);
        }

        public void InsertorganizationsAt(organizationsType newValue, int index)
        {
            InsertDomElementAt("http://www.imsproject.org/xsd/imscp_rootv1p1p2", "organizations", index, newValue);
        }

        public void ReplaceorganizationsAt(organizationsType newValue, int index)
        {
            ReplaceDomElementAt("http://www.imsproject.org/xsd/imscp_rootv1p1p2", "organizations", index, newValue);
        }
        ...
        {
            return DomChildCount(NodeType.Element, "http://www.imsproject.org/xsd/imscp_rootv1p1p2", "resources");
        }
        ...
        {
            return HasDomChild(NodeType.Element, "http://www.imsproject.org/xsd/imscp_rootv1p1p2", "resources");
        }

        public resourcesType GetresourcesAt(int index)
        {
            return new resourcesType(GetDomChildAt(NodeType.Element, "http://www.imsproject.org/xsd/imscp_rootv1p1p2", "resources", index));
        }
        ...
        {
            RemoveDomChildAt(NodeType.Element, "http://www.imsproject.org/xsd/imscp_rootv1p1p2", "resources", index);
        }
        ...
        {
            AppendDomElement("http://www.imsproject.org/xsd/imscp_rootv1p1p2", "resources", newValue);
        }

        public void InsertresourcesAt(resourcesType newValue, int index)
        {
            InsertDomElementAt("http://www.imsproject.org/xsd/imscp_rootv1p1p2", "resources", index, newValue);
        }

        public void ReplaceresourcesAt(resourcesType newValue, int index)
        {
            ReplaceDomElementAt("http://www.imsproject.org/xsd/imscp_rootv1p1p2", "resources", index, newValue);
        }
        ...
        {
            return DomChildCount(NodeType.Element, "http://www.imsproject.org/xsd/imscp_rootv1p1p2", "manifest");
        }
        ...
        {
            return HasDomChild(NodeType.Element, "http://www.imsproject.org/xsd/imscp_rootv1p1p2", "manifest");
        }

        public manifestType GetmanifestAt(int index)
        {
            return new manifestType(GetDomChildAt(NodeType.Element, "http://www.imsproject.org/xsd/imscp_rootv1p1p2", "manifest", index));
        }
        ...
        {
            RemoveDomChildAt(NodeType.Element, "http://www.imsproject.org/xsd/imscp_rootv1p1p2", "manifest", index);
        }
        ...
        {
            InsertDomElementAt("http://www.imsproject.org/xsd/imscp_rootv1p1p2", "manifest", index, newValue);
        }
