...
namespace adlcp_rootv1p2.imscp
{
    public class resourcesType : Altova.Node
    {
        ...
        public adlcp_resourceType GetresourceAt(int index)
        {
            return new adlcp_resourceType(GetDomChildAt(NodeType.Element, "http://www.imsproject.org/xsd/imscp_rootv1p1p2", "resource", index));
        }

        public adlcp_resourceType Getresource()
        {
            return GetresourceAt(0);
        }

        public adlcp_resourceType resource
        {
            get
            {
                return GetresourceAt(0);
